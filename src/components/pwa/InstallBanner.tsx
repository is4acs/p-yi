...
export function InstallBanner() {
  ...
  return (
    <div
      ...
      className="fixed inset-x-3 bottom-[calc(var(--bottom-nav-height,64px)+12px)] z-40 mx-auto max-w-md rounded-xl border border-peyi-orange-200 bg-white p-4 shadow-lg animate-in fade-in slide-in-from-bottom-4 duration-300 sm:mx-0 sm:w-[22rem] lg:inset-x-auto lg:left-4 lg:bottom-4"
    >
      <button
        type="button"
        onClick={dismiss}
